...
export const MESSAGES = {
  ja: {
    ...
    homeLayerGuideTitle: "LAYER Guide",
    homeLayerGuideDesc: "メンタルモデルを3つのレイヤーに分類。あなたの課題に合ったモデルを見つけやすくしました。",
    homeLayerMeta: "META",
    homeLayerMetaDesc: "思考の土台となる哲学や原理原則。複数の分野に応用できる普遍的な考え方です。",
    homeLayerCore: "CORE",
    homeLayerCoreDesc: "実務の中核となるマネジメント・戦略フレームワーク。組織や事業の判断に直結します。",
    homeLayerTool: "TOOL",
    homeLayerToolDesc: "分析やアイデア出しなど、具体的な課題解決に用いる実践的なメソッドです。",
  ...
  en: {
    ...
    homeLayerGuideTitle: "LAYER Guide",
    homeLayerGuideDesc: "Mental models organized in 3 layers to help you find models that fit your challenge.",
    homeLayerMeta: "META",
    homeLayerMetaDesc: "Fundamental philosophies and principles of thinking. Universal frameworks applicable across disciplines.",
    homeLayerCore: "CORE",
    homeLayerCoreDesc: "Core frameworks for management and strategy. Direct impact on organizational and business decisions.",
    homeLayerTool: "TOOL",
    homeLayerToolDesc: "Practical methods for analysis and ideation. Real-world problem solving toolkit.",
