...
1. **Identify the Facts (Raw Data)**
   Identify objective facts that could be recorded by a video camera, free from any interpretation.
2. **Be Conscious of Selection and Interpretation**
   Reflect on which data points you focused on (selection) and what meaning you assigned to them (interpretation).
3. **Verify Assumptions and Conclusions**
   Clarify what assumptions were made based on the interpretation and what conclusion was reached. Then, ask yourself, **"Is this based on fact?"** as if descending the ladder rung by rung.
...
* **Debugging Misunderstandings**
  Deconstructing the inference: "Email reply is late (Fact)" → "I am being ignored (Interpretation)" → "The person is unmotivated (Conclusion)," and then re-verifying the validity of the interpretation.
* **Platform for Dialogue**
  When opinions clash in a meeting, build consensus by sharing the process: "Based on these facts, I inferred this way and reached this conclusion."
