...
sources:
  - title: "Business Analysis Body of Knowledge (BABOK)"
    ...
    sourceLanguage: "en"
    description: "A standard guide for business analysis, systematically describing the definition of current and future states."
format_version: 0.4
---
...
1. **Analyze the Current State (As-Is) Dispassionately**
   List the current processes and resources exactly as they are, based on numerical data and objective facts.
2. **Define the Ideal State (To-Be) Specifically**
   Set aside constraints temporarily and describe the purpose or state you wish to achieve. It is preferable for this to be a **SMART** goal.
3. **Identify the Gap and Derive Actions**
   List the steps necessary to fill the difference between the **As-Is** and **To-Be**, and translate them into a prioritized execution plan (roadmap).
